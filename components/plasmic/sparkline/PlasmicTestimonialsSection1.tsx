...
import sty from "./PlasmicTestimonialsSection1.module.css"; // plasmic-import: rjdV6bmTkzIk/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__wxDoX)}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__wTbqo)}
              ...
              <Testimonial
                className={classNames(
                  "__wab_instance",
                  sty.testimonial___8DLmy
                )}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__f5VfF)}
                    displayHeight={"64px" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"none" as const}
                    displayMinHeight={"0" as const}
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__gYlGl)}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__wpU)}
              ...
              <Testimonial
                className={classNames(
                  "__wab_instance",
                  sty.testimonial___8HWe4
                )}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__gkEhb)}
                    displayHeight={"64px" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"none" as const}
                    displayMinHeight={"0" as const}

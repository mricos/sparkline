...
import sty from "./PlasmicValueprop.module.css"; // plasmic-import: TeGYHKYxFO1a/css
...
function PlasmicValueprop__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__hy22, {
          [sty.freeBoxcard__hy22S3FBb]: hasVariant(variants, "card", "card"),
          [sty.freeBoxcolor_lightQuarternary__hy22B9SdP]: hasVariant(
            variants,
            "color",
            "lightQuarternary"
          ),
          [sty.freeBoxflatIcon__hy22Vyn6E]: hasVariant(
            variants,
            "flatIcon",
            "flatIcon"
          ),
          [sty.freeBoxflat__hy22Dy8S4]: hasVariant(variants, "flat", "flat"),
          [sty.freeBoxvertical__hy22Ce2I7]: hasVariant(
            variants,
            "vertical",
            "vertical"
          ),
          [sty.freeBoxvertical_card__hy22Ce2I7S3FBb]:
            hasVariant(variants, "card", "card") &&
            hasVariant(variants, "vertical", "vertical")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__egBdz)}
      ...
      {false ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__ce7Xq, {
            [sty.freeBoxcard__ce7XqS3FBb]: hasVariant(variants, "card", "card"),
            [sty.freeBoxcolor_lightQuarternary__ce7XqB9SdP]: hasVariant(
              variants,
              "color",
              "lightQuarternary"
            ),
            [sty.freeBoxflatIcon__ce7XqVyn6E]: hasVariant(
              variants,
              "flatIcon",
              "flatIcon"
            ),
            [sty.freeBoxflat__ce7XqDy8S4]: hasVariant(variants, "flat", "flat"),
            [sty.freeBoxvertical__ce7XqCe2I7]: hasVariant(
              variants,
              "vertical",
              "vertical"
            ),
            [sty.freeBoxvertical_card__ce7XqCe2I7S3FBb]:
              hasVariant(variants, "card", "card") &&
              hasVariant(variants, "vertical", "vertical")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon8Icon
                className={classNames(projectcss.all, sty.svg__buSx4)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__h1LrN, {
          [sty.freeBoxflat__h1LrNdy8S4]: hasVariant(variants, "flat", "flat"),
          [sty.freeBoxjustDescription__h1LrNrKygt]: hasVariant(
            variants,
            "justDescription",
            "justDescription"
          )

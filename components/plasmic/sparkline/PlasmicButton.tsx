...
import sty from "./PlasmicButton.module.css"; // plasmic-import: ubZ4DzFcB6XW/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___1NY0V)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___5MqxN)}
                role={"img"}
              />
            ),

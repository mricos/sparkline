...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: KmyQoT_FMet_/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__gh8Zv)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__janxy)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__hVdTs)}
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__fnSmj)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__gdg8)}>
            {p.renderPlasmicSlot({
